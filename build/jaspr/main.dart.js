// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.1.2.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    CourseContents: function CourseContents(t0) {
      this.key = t0;
    },
    printString(string) {
    ...
    div(children, attributes, classes) {
      var _null = null;
      return new A.DomComponent("div", _null, classes, _null, attributes, _null, _null, children, _null);
    },
    ul(children, classes) {
      var _null = null;
    ...
    li(children, classes) {
      ...
      return new A.DomComponent("li", _null, classes, _null, t1, _null, _null, children, _null);
    },
    p(children, classes) {
      var _null = null;
    ...
    main() {
      ...
      t1 = new A.BrowserAppBinding(t2, null, false, A.LinkedHashMap_LinkedHashMap$_empty(t1, type$.SyncState_dynamic), B.SchedulerPhase_0, A._setArrayType([], type$.JSArray_of_void_Function));
      t3 = self.jaspr;
      stateData = A.decodeConfig(t3 == null ? null : J.get$sync$x(t3));
      if (stateData != null)
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2 = A._setArrayType([new A.Text("40+ hours of content", false, null)], t1);
                t3 = type$.JSArray_String;
                t4 = A._setArrayType(["tag", "is-link", "is-normal"], t3);
                t5 = A.p(A._setArrayType([new A.Text("The Complete Flutter App Development Course", false, null)], t1), A._setArrayType(["title", "is-1", "is-size-1-mobile", "has-text-weight-bold", "pb-4"], t3));
                t6 = A.p(A._setArrayType([new A.Text("From zero to Flutter hero", false, null)], t1), A._setArrayType(["subtitle", "is-4", "pb-6"], t3));
                t7 = A.p(A._setArrayType([new A.Text('Are you ready to dive into the world of mobile app development and create stunning, high-performance applications? Look no further! Welcome to "The Complete Flutter App Development Course" \u2014 your gateway to becoming a proficient Flutter developer.', false, null)], t1), A._setArrayType(["subtitle", "is-5", "has-text-grey", "pb-6"], t3));
                t8 = A._setArrayType([], t3);
                t9 = type$.String;
                t10 = A.LinkedHashMap_LinkedHashMap$of(A.LinkedHashMap_LinkedHashMap$_empty(t9, t9), t9, t9);
                t10.$indexSet(0, "src", "/assets/course.png");
                t2 = A.div(A._setArrayType([new A.DomComponent("span", null, t4, null, null, null, null, t2, null), t5, t6, t7, A.div(A._setArrayType([new A.DomComponent("img", null, t8, null, t10, null, null, null, null)], t1), null, A._setArrayType(["box"], t3))], t1), null, A._setArrayType(["column", "is-6", "is-offset-3"], t3));
                t4 = A._setArrayType([A.p(A._setArrayType([new A.Text("What people are saying about the Tutor", false, null)], t1), A._setArrayType(["subtitle", "is-3", "pb-4", "has-text-weight-bold"], t3))], t1);
                t5 = A._setArrayType(["senja-embed", "pt-6"], t3);
                t1 = A._setArrayType([A.div(A._setArrayType([A.div(A._setArrayType([t2, A.div(t4, A.LinkedHashMap_LinkedHashMap$_literal(["data-id", "f70a263f-84fb-44cb-956d-281854d41688", "data-lazyload", "false"], t9, t9), t5), new A.CourseContents(null)], t1), null, A._setArrayType(["container", "has-text-centered"], t3))], t1), null, A._setArrayType(["hero-body"], t3))], t1);
                $async$goto = 2;
                return $async$iterator._async$_current = new A.DomComponent("section", null, A._setArrayType(["hero is-info", "is-fullheight"], t3), null, null, null, null, t1, null), 1;
              case 2:
                // after yield
                // implicit return
                return 0;
  ...
  A.CourseContents.prototype = {
    build$1(context) {
      return new A._SyncStarIterable(this.build$body$CourseContents(context), type$._SyncStarIterable_Component);
    },
    build$body$CourseContents($async$context) {
      return function() {
        var context = $async$context;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$goto = 2;
                return $async$iterator._async$_current = A.div(A._setArrayType([A.p(A._setArrayType([new A.Text("What you will learn", false, null)], t1), A._setArrayType(["subtitle", "is-3", "pb-4", "has-text-weight-bold"], t2)), A.div(A._setArrayType([A.div(A._setArrayType([A.ul(A._setArrayType([A.li(A._setArrayType([new A.Text("\ud83d\ude80 Master the Fundamentals: From setting up your development environment to understanding Dart basics, we'll cover it all", false, null)], t1), A._setArrayType(["has-text-left"], t2)), A.li(A._setArrayType([new A.Text("\ud83c\udfa8 Craft Visually Stunning UIs: Learn to design beautiful, intuitive user interfaces that captivate your users.", false, null)], t1), null), A.li(A._setArrayType([new A.Text("\ud83d\udca1 Leverage Widgets for Functionality: Dive deep into Flutter's widget-based architecture for seamless functionality and interactivity.", false, null)], t1), null), A.li(A._setArrayType([new A.Text("\ud83d\udcf1 Build Adaptive Apps: Create apps that feel native on Android and iOS with one codebase.", false, null)], t1), null)], t1), A._setArrayType(["bullet-points", "has-text-left"], t2))], t1), null, A._setArrayType(["column", "is-half"], t2)), A.div(A._setArrayType([A.ul(A._setArrayType([A.li(A._setArrayType([new A.Text("\ud83d\udd04 State Management Mastery: Understand and implement efficient state management techniques for smooth app performance", false, null)], t1), null), A.li(A._setArrayType([new A.Text("\ud83c\udf10 Network and Database Integration: Integrate with APIs and databases for dynamic, data-driven applications.", false, null)], t1), null), A.li(A._setArrayType([new A.Text("\ud83e\uddea Testing and Debugging: Ensure your app is robust and bug-free with comprehensive testing strategies.", false, null)], t1), null), A.li(A._setArrayType([new A.Text("\ud83d\ude80 Publishing and Deployment: Get your app ready for prime time with tips on deployment and publication.", false, null)], t1), null)], t1), A._setArrayType(["bullet-points", "has-text-left"], t2))], t1), null, A._setArrayType(["column", "is-half"], t2))], t1), null, A._setArrayType(["columns"], t2))], t1), null, A._setArrayType(["container"], t2)), 1;
              case 2:
                // after yield
                // implicit return
                return 0;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.MapBase_entries_closure, A.ComponentsBinding_attachRootComponent__closure, A.Element__updateAncestorSiblingRecursively_closure, A.MultiChildElement_updateChildren_replaceWithNullIfForgotten]);
    _inheritMany(A.Closure2Args, [A.CastMap_forEach_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A.DomNodeData_clearEvents_closure]);
    ...
    _inheritMany(A.StatelessComponent, [A.App, A.CourseContents]);
